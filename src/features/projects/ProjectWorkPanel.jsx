...
function TaskCard({ task, onOpen }) {
  ...
  return <button type="button" onClick={onOpen} className="block min-h-24 w-full min-w-0 rounded-xl border border-zinc-800 bg-zinc-950 p-3.5 text-left transition hover:border-zinc-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-500 sm:p-4">
