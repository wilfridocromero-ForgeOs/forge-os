    ...
    <form onSubmit={save} className="mx-auto my-2 w-full max-w-3xl overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950 shadow-2xl sm:my-6">
      ...
      <div className="space-y-6 p-4 sm:p-6">
        <section className="grid min-w-0 gap-3 sm:grid-cols-2">
          ...
          <label className="min-w-0 sm:col-span-2"><span className="mb-1 block text-xs text-zinc-500">Descripción opcional</span><textarea maxLength={2000} rows={3} className={`${field} w-full resize-y`} value={details.description} onChange={(event) => setDetails({ ...details, description: event.target.value })} /></label>
