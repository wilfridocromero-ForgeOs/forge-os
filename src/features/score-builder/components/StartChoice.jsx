    ...
    return (
        <div className="mx-auto w-full max-w-6xl">
            ...
            <div className="mb-8 text-center sm:mb-12">
                ...
                <h1 className="text-3xl font-bold text-zinc-950 dark:text-white sm:text-4xl lg:text-5xl">
                    ...
                    return (
                        ...
                        <button
                            ...
                            className={`
                                ...
                                ${
                                    active
                                        ? "border-zinc-950 bg-zinc-950 text-white shadow-xl dark:border-white dark:bg-white dark:text-black"
                                        : "border-zinc-200 bg-white text-zinc-950 hover:border-zinc-400 hover:bg-zinc-50 dark:border-zinc-800 dark:bg-[#111113] dark:text-white dark:hover:border-zinc-600 dark:hover:bg-zinc-900 lg:hover:-translate-y-1"
                                }
                            `}
                        >
