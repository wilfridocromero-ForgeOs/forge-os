...
const initial = { name: "", description: "", division_id: "", client_id: "", owner_id: "", priority: "medium", status: "planned", progress: 0, starts_at: "", due_at: "" };
  ...
  return <Modal open={open} onClose={onClose} title={project ? "Editar proyecto" : "Nuevo proyecto"} subtitle="Información operativa conectada con clientes y divisiones." size="lg">
    <form onSubmit={submit} className="space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="text-sm text-zinc-400">Progreso ({form.progress}%)<input type="range" min="0" max="100" step="5" className="mt-4 w-full accent-white" value={form.progress} onChange={(e) => set("progress", e.target.value)} /></label>
